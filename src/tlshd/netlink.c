...
/**
 * @var int tlshd_delay_done
 * @brief Global number of seconds to delay each handshake completion
 */
...
/**
 * @var tlshd_accept_nl_policy
 * @brief Netlink policies for ACCEPT arguments
 */
...
/**
 * @var tlshd_notification_nls
 * @brief Netlink socket on which notification events arive
 */
...
/**
 * @var tlshd_x509_nl_policy
 * @brief Netlink policies for x.509 key serial numbers
 */
#if LIBNL_VER_NUM >= LIBNL_VER(3,5)
static const struct nla_policy
#else
...
/**
 * @var tlshd_default_handshake_parms
 * @brief Starting parameter values for each handshake
 */
