...
/**
 * @var int tlshd_debug
 * @brief Global debug verbosity setting
 */
int tlshd_debug;

/**
 * @var int tlshd_tls_debug
 * @brief Global debug verbosity setting for TLS library calls
 */
int tlshd_tls_debug;

/**
 * @var int tlshd_stderr
 * @brief Global setting to output on stderr as well as syslog
 */
int tlshd_stderr;
